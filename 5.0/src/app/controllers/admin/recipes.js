   ...
   async showHomepage(req,res) {
        ...
        const params = {
            ...
            callback(recipes) {
                ...
                return res.render('./site/index', {recipes:final_recipes, pagination, filter});
            }
        }
    ...
    showRecipesPage(req, res) {
        ...
        const params = {
            ...
            callback(recipes) {
                ...
                return res.render('./site/recipes', {recipes:final_recipes, pagination, filter});
            }
        }
    ...
    async showSpecificRecipe(req, res) {
        ...
        return res.render('./site/show', { recipe, chefsOptions, files });
    }
}