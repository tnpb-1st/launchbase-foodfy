...
module.exports = {
    ...
    async post(req, res) {
        ...
        if (fillAllFields) {
            return res.render('admin/recipes/create.njk', fillAllFields)
        }
...
''
    ...
    async put(req,res) {
        ...
        if (fillAllFields) {
            return res.render('admin/recipes/edit.njk', fillAllFields)
        }
   ...
   async showHomepage(req,res) {
        ...
        if (recipes.length === 0) return res.render('site/general/home')
    ...
    async showSpecificRecipe(req, res) {
        ...
        if (!recipe) return res.render('/site/recipes/show.njk', {
            error: 'receita não encontrada'
        });
